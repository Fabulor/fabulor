...
- [ ] Add the GTK4 theme adapter and validate tray, notifications, icons, fonts, and platform integration.
  ...
  - [x] Import bounded OpenDesktop.org GTK4 theme archives into contained profile theme directories without source-based trust exemptions.
...
- [ ] Complete clean-install, upgrade, accessibility, visual, performance, plugin, and packaging validation.
  ...
  - [x] Preserve and recover the GTK4 right-pane width across final window allocation, channel switching, and Preferences reparenting without reintroducing channel-switch lag.

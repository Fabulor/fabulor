...
static const GdkRGBA legacy_dark_defaults[THEME_LEGACY_MAX + 1] = {
	PALETTE_COLOR_INIT (0xf2f2, 0xf2f2, 0xf2f2), PALETTE_COLOR_INIT (0xb8b8, 0xb8b8, 0xb8b8),
	PALETTE_COLOR_INIT (0x6e6e, 0xa8a8, 0xfefe), PALETTE_COLOR_INIT (0x4a4a, 0xdede, 0x8080),
	PALETTE_COLOR_INIT (0xffff, 0x6b6b, 0x6b6b), PALETTE_COLOR_INIT (0xd7d7, 0x8a8a, 0x8a8a),
	PALETTE_COLOR_INIT (0xc0c0, 0x8484, 0xfcfc), PALETTE_COLOR_INIT (0xf6f6, 0xadad, 0x5555),
	PALETTE_COLOR_INIT (0xfdfd, 0xe0e0, 0x6868), PALETTE_COLOR_INIT (0xa7a7, 0xf3f3, 0xd0d0),
	PALETTE_COLOR_INIT (0x2d2d, 0xd4d4, 0xbfbf), PALETTE_COLOR_INIT (0x6767, 0xe8e8, 0xf9f9),
	PALETTE_COLOR_INIT (0x8181, 0x8c8c, 0xf8f8), PALETTE_COLOR_INIT (0xf0f0, 0xabab, 0xfcfc),
	PALETTE_COLOR_INIT (0x9494, 0xa3a3, 0xb8b8), PALETTE_COLOR_INIT (0xe5e5, 0xe7e7, 0xebeb),
	PALETTE_COLOR_INIT (0xf2f2, 0xf2f2, 0xf2f2), PALETTE_COLOR_INIT (0xb8b8, 0xb8b8, 0xb8b8),
	PALETTE_COLOR_INIT (0x6e6e, 0xa8a8, 0xfefe), PALETTE_COLOR_INIT (0x4a4a, 0xdede, 0x8080),
	PALETTE_COLOR_INIT (0xffff, 0x6b6b, 0x6b6b), PALETTE_COLOR_INIT (0xd7d7, 0x8a8a, 0x8a8a),
	PALETTE_COLOR_INIT (0xc0c0, 0x8484, 0xfcfc), PALETTE_COLOR_INIT (0xf6f6, 0xadad, 0x5555),
	...
	PALETTE_COLOR_INIT (0x8181, 0x8c8c, 0xf8f8), PALETTE_COLOR_INIT (0xf0f0, 0xabab, 0xfcfc),
	PALETTE_COLOR_INIT (0x9494, 0xa3a3, 0xb8b8), PALETTE_COLOR_INIT (0xe5e5, 0xe7e7, 0xebeb),
	PALETTE_COLOR_INIT (0xffff, 0xffff, 0xffff), PALETTE_COLOR_INIT (0x3a3a, 0x6565, 0xa0a0),
	PALETTE_COLOR_INIT (0xe6e6, 0xe6e6, 0xe6e6), PALETTE_COLOR_INIT (0x1f1f, 0x2323, 0x2929),
	PALETTE_COLOR_INIT (0x5050, 0x5555, 0x5f5f), PALETTE_COLOR_INIT (0x6e6e, 0xa8a8, 0xfefe),
	PALETTE_COLOR_INIT (0xfdfd, 0xe0e0, 0x6868), PALETTE_COLOR_INIT (0xffff, 0x6b6b, 0x6b6b),
	PALETTE_COLOR_INIT (0x9494, 0xa3a3, 0xb8b8), PALETTE_COLOR_INIT (0xffff, 0x6b6b, 0x6b6b),
};

...
static const char *theme_css_selector_input = "#fabulor-inputbox";
static const char *theme_css_selector_input_text = "#fabulor-inputbox text";
static const char *theme_css_selector_palette_class = "fabulor-palette";
static const char *theme_css_selector_dark_class = "fabulor-dark";
static const char *theme_css_selector_light_class = "fabulor-light";
static const char *theme_css_palette_provider_key = "fabulor-palette-provider";
...
static const char *theme_css_palette_scope_selectors =
	".fabulor-palette, .fabulor-palette *, .fabulor-palette box, .fabulor-palette grid, .fabulor-palette stack, .fabulor-palette frame, .fabulor-palette paned, .fabulor-palette paned > separator, .fabulor-palette separator, .fabulor-palette viewport, .fabulor-palette overlay, .fabulor-palette revealer, .fabulor-palette notebook, .fabulor-palette notebook > header, .fabulor-palette notebook > header > tabs, .fabulor-palette notebook > header > tabs > tab, .fabulor-palette scrolledwindow, .fabulor-palette scrollbar, .fabulor-palette scrollbar slider, .fabulor-palette scrollbar trough, .fabulor-palette treeview, .fabulor-palette treeview.view, .fabulor-palette treeview.view text, .fabulor-palette treeview.view cell, .fabulor-palette treeview.view row, .fabulor-palette treeview header, .fabulor-palette treeview header button, .fabulor-palette list, .fabulor-palette list row, .fabulor-palette row, .fabulor-palette textview, .fabulor-palette textview text, .fabulor-palette text, .fabulor-palette entry, .fabulor-palette entry text, .fabulor-palette button, .fabulor-palette button label, .fabulor-palette check, .fabulor-palette switch, .fabulor-palette slider, .fabulor-palette scale, .fabulor-palette scale trough, .fabulor-palette scale highlight, .fabulor-palette spinbutton, .fabulor-palette combobox, .fabulor-palette combobox box, .fabulor-palette progressbar, .fabulor-palette progressbar trough, .fabulor-palette levelbar, .fabulor-palette levelbar trough, .fabulor-palette menubar, .fabulor-palette menu, .fabulor-palette menuitem, .fabulor-palette menuitem label, .fabulor-palette toolbar, .fabulor-palette headerbar, .fabulor-palette label, .fabulor-palette link, .fabulor-palette infobar, .fabulor-palette statusbar, .fabulor-palette statusbar frame, .fabulor-palette tooltip, .fabulor-palette tooltip label";
static const char *theme_css_palette_selection_selectors =
	".fabulor-palette *:selected, .fabulor-palette *:selected:focus, .fabulor-palette *:selected:hover, .fabulor-palette treeview.view:selected, .fabulor-palette treeview.view:selected:focus, .fabulor-palette treeview.view:selected:hover, .fabulor-palette row:selected, .fabulor-palette row:selected:focus, .fabulor-palette row:selected:hover, .fabulor-palette selection, .fabulor-palette text selection, .fabulor-palette entry selection, .fabulor-palette entry text selection, .fabulor-palette button:selected, .fabulor-palette button:checked, .fabulor-palette check:checked, .fabulor-palette switch:checked, .fabulor-palette slider:active, .fabulor-palette menuitem:selected, .fabulor-palette menuitem:hover, .fabulor-palette notebook > header > tabs > tab:checked, .fabulor-palette notebook > header > tabs > tab:hover, .fabulor-palette treeview header button:hover, .fabulor-palette treeview header button:active, .fabulor-palette progressbar progress, .fabulor-palette levelbar block.filled, .fabulor-palette:focus selection, .fabulor-palette:focus text selection";

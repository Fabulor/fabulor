...
allowlists the certificate, OpenSSL, CFFI, and Python API support
...
python tools\gtk4\stage_production_support.py --dependency-root C:\fabulor-master\build\vcpkg-installed\x64-windows --python-build-root C:\gtk-build\python-3.14\x64 --repository-root C:\fabulor-master --output C:\fabulor-master\build\gtk4-production-support

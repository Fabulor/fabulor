...
Status: Stage 5 conversion contract
...
3. `GtkMultiSelection` for the existing multi-row workflows; and
...
1. Convert a contained flat operational list and validate the shared stack and
   factory lifecycle.

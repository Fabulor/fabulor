...
| Themes | `theme/*.c`, `common/gtk3-theme-service.c`, `common/gtk4-theme-discovery.c` | GTK4 CSS compatibility and adapter policy | in progress; exact GTK4 desktop/profile discovery boundary established |
